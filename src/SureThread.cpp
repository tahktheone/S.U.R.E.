...
*/
    ...
    OCL_PROGRAM(program_t,"./CL/raytrace_d.cl","-w -cl-fast-relaxed-math -I./CL -D SURE_RLEVEL=100");
    OCL_PROGRAM(program_f,"./CL/raytrace_t.cl","-w -cl-fast-relaxed-math -I./CL -D SURE_RLEVEL=100");
    ...
    OCL_PROGRAM(program_n,"./CL/raytrace_d.cl","-w -cl-fast-relaxed-math -I./CL -D SURE_RLEVEL=10");
