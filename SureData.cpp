...
SureData::SureData()
{
  ...
  Scene_cube(-30,-30,18,17,SURE_NORMALS_DEFAULT,SURE_MAPPING_PLANAR_XZ);
  Scene_cube(20,20,15,14,SURE_NORMALS_DEFAULT,SURE_MAPPING_PLANAR_XZ);
  Scene_cube(-20,20,25,14,SURE_NORMALS_DEFAULT,SURE_MAPPING_PLANAR_YZ);
  Scene_floor();
  //Scene_golem();
